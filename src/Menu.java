...
public class Menu {
    ...
    public void Selection() throws IOException {
        ...
        while(true){
            ...
            if(var == 5){
                ...
                System.out.println("\n\n\n");
                FileWorking file = new FileWorking();
                file.FileReading("C:\\Users\\mk410\\OneDrive\\Desktop\\JavaProjects\\MasterChief\\src\\Salats.txt");
                ...
                System.out.println("\n\n\n");
                FileWorking file = new FileWorking();
                file.FileReading("C:\\Users\\mk410\\OneDrive\\Desktop\\JavaProjects\\MasterChief\\src\\Help.txt");
                System.out.print("Insert any number to continue: ");
                int numb = scanner.nextInt();
            }
        }
    ...
    private List<Food> FoodRemove(List<Food> veg){
        /*
